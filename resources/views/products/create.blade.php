                    ...
                    <div class="card-body"> 
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" @error('description') is-invalid @enderror name="description" rows="5" value="{{ old('description') }}" placeholder="Masukkan Description Product">{{ old('description') }}</textarea>
